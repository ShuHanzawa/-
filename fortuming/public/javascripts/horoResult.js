window.onload = function() {
    ...
    const horoscope = params.get("horoscope");
    const blood = params.get("blood");
    const eto = params.get("eto");
    console.log(horoscope + blood + eto);
...
const yydd = (month + day);
  ...
  const result = (Number(horoscope) + Number(blood) + Number(eto) + yydd) % 5;
  console.log(result);
